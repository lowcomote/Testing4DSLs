...
public class CustomK3Launcher extends AbstractSequentialGemocLauncher<GenericModelExecutionContext<ISequentialRunConfiguration>, ISequentialRunConfiguration> {

	public final static String TYPE_ID = Activator.PLUGIN_ID + ".launcher";
	
	public GenericModelExecutionContext<ISequentialRunConfiguration> executioncontext;
	
	@Override
	public IExecutionEngine<GenericModelExecutionContext<ISequentialRunConfiguration>> createExecutionEngine(ISequentialRunConfiguration runConfiguration,
