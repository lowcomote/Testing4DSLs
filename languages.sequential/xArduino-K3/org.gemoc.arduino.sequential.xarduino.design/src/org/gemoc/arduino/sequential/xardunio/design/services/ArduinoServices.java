...
import org.gemoc.sequential.model.arduino.UnaryOperatorKind;
...
//	public void updateDigitalPins(Board platform, String totalOfPins) {
...
//
	public String computeLabel(Expression expression) {
		if (expression instanceof UnaryExpression) {
			return getOperator(((UnaryExpression) expression).getOperator()) +
					computeLabel(((UnaryExpression) expression).getOperand());
		}
		...
		if (expression instanceof BinaryExpression) {
			return "(" + computeLabel(((BinaryExpression) expression).getLeft())
					+ getOperator(((BinaryExpression) expression).getOperator())
...
//	}
//
	public String getOperator(BinaryOperatorKind operator) {
		switch (operator) {
		case DIV:
			return "/";
		case MAX:
	...
	public String getOperator(UnaryOperatorKind operator) {
		switch (operator) {
		case MINUS:
			return "-";
		case NEG:
