 ...
 * </p>
 * <ul>
 *   <li>{@link arduino.impl.BoardImpl#getModules <em>Modules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoardImpl extends NamedElementImpl implements Board {
	...
	public EList<arduino.Module> getModules() {
		if (modules == null) {
			modules = new EObjectContainmentEList<arduino.Module>(arduino.Module.class, this, ArduinoPackage.BOARD__MODULES);
		}
		return modules;
	}
