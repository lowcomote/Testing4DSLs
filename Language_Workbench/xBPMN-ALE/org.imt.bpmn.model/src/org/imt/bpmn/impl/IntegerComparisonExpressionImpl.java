 ...
 * </p>
 * <ul>
 *   <li>{@link org.imt.bpmn.impl.IntegerComparisonExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.imt.bpmn.impl.IntegerComparisonExpressionImpl#getOperand1 <em>Operand1</em>}</li>
 *   <li>{@link org.imt.bpmn.impl.IntegerComparisonExpressionImpl#getOperand2 <em>Operand2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerComparisonExpressionImpl extends ExpressionImpl implements IntegerComparisonExpression {
	...
	protected EClass eStaticClass() {
		return bpmnPackage.Literals.INTEGER_COMPARISON_EXPRESSION;
	}
	...
	public void setOperator(IntegerComparisonOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, bpmnPackage.INTEGER_COMPARISON_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public IntegerVariable getOperand1() {
		if (operand1 != null && operand1.eIsProxy()) {
			...
			if (operand1 != oldOperand1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, bpmnPackage.INTEGER_COMPARISON_EXPRESSION__OPERAND1, oldOperand1, operand1));
			}
		}
		return operand1;
	}
	...
	public void setOperand1(IntegerVariable newOperand1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, bpmnPackage.INTEGER_COMPARISON_EXPRESSION__OPERAND1, oldOperand1, operand1));
	}
	...
	public IntegerVariable getOperand2() {
		if (operand2 != null && operand2.eIsProxy()) {
			...
			if (operand2 != oldOperand2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, bpmnPackage.INTEGER_COMPARISON_EXPRESSION__OPERAND2, oldOperand2, operand2));
			}
		}
		return operand2;
	}
	...
	public void setOperand2(IntegerVariable newOperand2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, bpmnPackage.INTEGER_COMPARISON_EXPRESSION__OPERAND2, oldOperand2, operand2));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case bpmnPackage.INTEGER_COMPARISON_EXPRESSION__OPERATOR:
				return getOperator();
			case bpmnPackage.INTEGER_COMPARISON_EXPRESSION__OPERAND1:
				if (resolve) return getOperand1();
				return basicGetOperand1();
			case bpmnPackage.INTEGER_COMPARISON_EXPRESSION__OPERAND2:
