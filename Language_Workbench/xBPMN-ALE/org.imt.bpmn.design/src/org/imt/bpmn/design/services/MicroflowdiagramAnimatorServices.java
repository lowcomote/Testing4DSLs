package org.imt.bpmn.design.services;
...
public class MicroflowdiagramAnimatorServices extends AbstractGemocAnimatorServices {
	...
	protected List<StringCouple> getRepresentationRefreshList() {
		...
		res.add(new StringCouple("MicroflowDiagram", "Animation"));
