 ...
 * @generated
 */
public class ChangeObjectItemProvider extends ObjectActivityItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ChangeObjectItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ChangeObject"));
	}
	...
	public String getText(Object object) {
		String label = ((ChangeObject)object).getLabel();
		return label == null || label.length() == 0 ?
			getString("_UI_ChangeObject_type") :
			getString("_UI_ChangeObject_type") + " " + label;
	}
