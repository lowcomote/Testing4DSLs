...
/**
 * This is the item provider adapter for a {@link org.imt.bpmn.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends VariableItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(bpmnPackage.Literals.ENTITY__ATTRIBUTES);
			childrenFeatures.add(bpmnPackage.Literals.ENTITY__REFERENCES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Entity.class)) {
			case bpmnPackage.ENTITY__ATTRIBUTES:
			case bpmnPackage.ENTITY__REFERENCES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(bpmnPackage.Literals.ENTITY__ATTRIBUTES,
		...
		newChildDescriptors.add
			(createChildParameter
				(bpmnPackage.Literals.ENTITY__REFERENCES,
				 bpmnFactory.eINSTANCE.createReference()));
	}
