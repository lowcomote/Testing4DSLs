...
import static extension org.imt.pssm.interpreter.CallEventOccurrenceAspect.*
import static extension org.imt.pssm.interpreter.ConstraintAspect.*
import static extension org.imt.pssm.interpreter.EventOccurrenceAspect.*
import static extension org.imt.pssm.interpreter.RegionAspect.*
import static extension org.imt.pssm.interpreter.StateAspect.*
...
class BooleanConstraintAspect extends ConstraintAspect{
	...
	protected def boolean evaluate(EventOccurrence eventOccurrence) {
		...
		return eventAttributeValue._value == if (_self.value) 1 else 0
	}
}
