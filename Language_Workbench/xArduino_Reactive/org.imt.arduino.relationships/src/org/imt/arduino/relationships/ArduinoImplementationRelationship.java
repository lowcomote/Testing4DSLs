...
public class ArduinoImplementationRelationship extends SimpleImplementationRelationship {
	...
	private static Map<String, String> computeEventToMethodMap() {
		...
		result.put("IRSensor_detected", "org.imt.arduino.interpreter.InfraRedSensorAspect.detect");
		result.put("IRSensor_notDetected", "org.imt.arduino.interpreter.InfraRedSensorAspect.notDetect");
		//Exposed rules
		result.put("Pin_level_changed", "org.imt.arduino.DigitalPin.changeLevel");
		return result;
	}
	private static Set<String> computeRunToCompletionMap(List<Event> events) {
		final Set<String> result = new HashSet<>();
		result.add("org.imt.arduino.interpreter.SketchAspect.execute");
		result.add("org.imt.arduino.interpreter.PushButtonAspect.press");
		result.add("org.imt.arduino.interpreter.PushButtonAspect.release");
		result.add("org.imt.arduino.interpreter.InfraRedSensorAspect.detect");
		result.add("org.imt.arduino.interpreter.InfraRedSensorAspect.notDetect");
		return result;
	}
