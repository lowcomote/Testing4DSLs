...
public class ArduinoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArduinoPackage.MODULE: {
				org.imt.arduino.nonreactive.arduino.Module module = (org.imt.arduino.nonreactive.arduino.Module)theEObject;
	 ...
	 * @generated
	 */
	public T caseModule(org.imt.arduino.nonreactive.arduino.Module object) {
		return null;
	}
