...
import org.imt.arduino.nonreactive.arduino.ArduinoFactory;
...
import org.imt.arduino.nonreactive.arduino.BinaryBooleanOperatorKind;
...
import org.imt.arduino.nonreactive.arduino.BinaryIntegerOperatorKind;
...
import org.imt.arduino.nonreactive.arduino.Color;
...
import org.imt.arduino.nonreactive.arduino.UnaryIntegerOperatorKind;
...
public class ArduinoPackageImpl extends EPackageImpl implements ArduinoPackage {
	 ...
	 * @see org.imt.arduino.nonreactive.arduino.ArduinoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(moduleEClass, org.imt.arduino.nonreactive.arduino.Module.class, "Module", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(ledEClass, org.imt.arduino.nonreactive.arduino.LED.class, "LED", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLED_Color(), this.getColor(), "color", "blue", 1, 1, org.imt.arduino.nonreactive.arduino.LED.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
