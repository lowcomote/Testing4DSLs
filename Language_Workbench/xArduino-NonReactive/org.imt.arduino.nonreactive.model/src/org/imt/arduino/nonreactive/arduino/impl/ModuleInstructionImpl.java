 ...
 * </p>
 * <ul>
 *   <li>{@link org.imt.arduino.nonreactive.arduino.impl.ModuleInstructionImpl#getModule <em>Module</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ModuleInstructionImpl extends InstructionImpl implements ModuleInstruction {
	 ...
	 * @ordered
	 */
	protected org.imt.arduino.nonreactive.arduino.Module module;
	 ...
	 * @generated
	 */
	public org.imt.arduino.nonreactive.arduino.Module getModule() {
		if (module != null && module.eIsProxy()) {
			InternalEObject oldModule = (InternalEObject)module;
			module = (org.imt.arduino.nonreactive.arduino.Module)eResolveProxy(oldModule);
			if (module != oldModule) {
	 ...
	 * @generated
	 */
	public org.imt.arduino.nonreactive.arduino.Module basicGetModule() {
		return module;
	}
	 ...
	 * @generated
	 */
	public void setModule(org.imt.arduino.nonreactive.arduino.Module newModule) {
		org.imt.arduino.nonreactive.arduino.Module oldModule = module;
		module = newModule;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ArduinoPackage.MODULE_INSTRUCTION__MODULE:
				setModule((org.imt.arduino.nonreactive.arduino.Module)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ArduinoPackage.MODULE_INSTRUCTION__MODULE:
				setModule((org.imt.arduino.nonreactive.arduino.Module)null);
				return;
		}
