 ...
 *   <li>{@link org.eclipse.gemoc.example.k3fsm.impl.FSMImpl#getConsumedString <em>Consumed String</em>}</li>
...
public class FSMImpl extends MinimalEObjectImpl.Container implements FSM {
	...
	public void setConsumedString(String newConsumedString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, K3fsmPackage.FSM__CONSUMED_STRING, oldConsumedString,
					consumedString));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case K3fsmPackage.FSM__CONSUMED_STRING:
	...
	public boolean eIsSet(int featureID) {
		...
		case K3fsmPackage.FSM__CONSUMED_STRING:
			return CONSUMED_STRING_EDEFAULT == null ? consumedString != null
					: !CONSUMED_STRING_EDEFAULT.equals(consumedString);
		case K3fsmPackage.FSM__PRODUCED_STRING:
