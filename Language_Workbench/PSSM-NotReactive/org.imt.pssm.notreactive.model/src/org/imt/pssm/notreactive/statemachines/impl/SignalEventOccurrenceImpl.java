 ...
 * </p>
 * <ul>
 *   <li>{@link org.imt.pssm.notreactive.statemachines.impl.SignalEventOccurrenceImpl#getSignal <em>Signal</em>}</li>
 *   <li>{@link org.imt.pssm.notreactive.statemachines.impl.SignalEventOccurrenceImpl#getAttributeValues <em>Attribute Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SignalEventOccurrenceImpl extends EventOccurrenceImpl implements SignalEventOccurrence {
	...
	public EList<AttributeValue> getAttributeValues() {
		if (attributeValues == null) {
			attributeValues = new EObjectResolvingEList<AttributeValue>(AttributeValue.class, this, StatemachinesPackage.SIGNAL_EVENT_OCCURRENCE__ATTRIBUTE_VALUES);
		}
