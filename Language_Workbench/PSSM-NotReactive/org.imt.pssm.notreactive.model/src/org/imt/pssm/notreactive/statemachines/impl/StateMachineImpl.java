 ...
 * </p>
 * <ul>
 *   <li>{@link org.imt.pssm.notreactive.statemachines.impl.StateMachineImpl#getRegions <em>Regions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateMachineImpl extends NamedElementImpl implements StateMachine {
	...
	public EList<Region> getRegions() {
		if (regions == null) {
			regions = new EObjectContainmentWithInverseEList<Region>(Region.class, this, StatemachinesPackage.STATE_MACHINE__REGIONS, StatemachinesPackage.REGION__STATE_MACHINE);
		}
		return regions;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StatemachinesPackage.STATE_MACHINE__REGIONS:
