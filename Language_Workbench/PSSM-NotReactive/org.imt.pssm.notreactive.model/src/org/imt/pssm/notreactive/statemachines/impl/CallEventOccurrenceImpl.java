 ...
 * </p>
 * <ul>
 *   <li>{@link org.imt.pssm.notreactive.statemachines.impl.CallEventOccurrenceImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link org.imt.pssm.notreactive.statemachines.impl.CallEventOccurrenceImpl#getInParameterValues <em>In Parameter Values</em>}</li>
 *   <li>{@link org.imt.pssm.notreactive.statemachines.impl.CallEventOccurrenceImpl#getOutParameterValues <em>Out Parameter Values</em>}</li>
 *   <li>{@link org.imt.pssm.notreactive.statemachines.impl.CallEventOccurrenceImpl#getReturnValue <em>Return Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CallEventOccurrenceImpl extends EventOccurrenceImpl implements CallEventOccurrence {
	...
	/**
	 * The cached value of the '{@link #getInParameterValues() <em>In Parameter Values</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getOutParameterValues() <em>Out Parameter Values</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<AttributeValue> getInParameterValues() {
		if (inParameterValues == null) {
			inParameterValues = new EObjectResolvingEList<AttributeValue>(AttributeValue.class, this, StatemachinesPackage.CALL_EVENT_OCCURRENCE__IN_PARAMETER_VALUES);
		}
	...
	public EList<AttributeValue> getOutParameterValues() {
		if (outParameterValues == null) {
			outParameterValues = new EObjectResolvingEList<AttributeValue>(AttributeValue.class, this, StatemachinesPackage.CALL_EVENT_OCCURRENCE__OUT_PARAMETER_VALUES);
		}
	...
	public AttributeValue getReturnValue() {
		if (returnValue != null && returnValue.eIsProxy()) {
			...
			returnValue = (AttributeValue)eResolveProxy(oldReturnValue);
			if (returnValue != oldReturnValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StatemachinesPackage.CALL_EVENT_OCCURRENCE__RETURN_VALUE, oldReturnValue, returnValue));
			}
		}
		return returnValue;
	}
	 ...
	 * @generated
	 */
	public AttributeValue basicGetReturnValue() {
		return returnValue;
	}
	...
	public void setReturnValue(AttributeValue newReturnValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatemachinesPackage.CALL_EVENT_OCCURRENCE__RETURN_VALUE, oldReturnValue, returnValue));
	}
