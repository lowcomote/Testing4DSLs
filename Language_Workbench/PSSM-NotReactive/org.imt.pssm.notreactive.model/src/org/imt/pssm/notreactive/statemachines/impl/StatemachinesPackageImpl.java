...
import org.imt.pssm.notreactive.statemachines.Attribute;
import org.imt.pssm.notreactive.statemachines.AttributeValue;
import org.imt.pssm.notreactive.statemachines.Behavior;
import org.imt.pssm.notreactive.statemachines.BooleanAttribute;
import org.imt.pssm.notreactive.statemachines.BooleanAttributeValue;
import org.imt.pssm.notreactive.statemachines.BooleanBinaryOperator;
import org.imt.pssm.notreactive.statemachines.BooleanConstraint;
import org.imt.pssm.notreactive.statemachines.BooleanUnaryOperator;
import org.imt.pssm.notreactive.statemachines.CallEventOccurrence;
import org.imt.pssm.notreactive.statemachines.CallEventType;
import org.imt.pssm.notreactive.statemachines.CompletionEventOccurrence;
import org.imt.pssm.notreactive.statemachines.Constraint;
import org.imt.pssm.notreactive.statemachines.CustomSystem;
import org.imt.pssm.notreactive.statemachines.EventOccurrence;
import org.imt.pssm.notreactive.statemachines.EventType;
import org.imt.pssm.notreactive.statemachines.FinalState;
import org.imt.pssm.notreactive.statemachines.IntegerAttribute;
import org.imt.pssm.notreactive.statemachines.IntegerAttributeValue;
import org.imt.pssm.notreactive.statemachines.IntegerComparisonOperator;
import org.imt.pssm.notreactive.statemachines.IntegerConstraint;
import org.imt.pssm.notreactive.statemachines.NamedElement;
import org.imt.pssm.notreactive.statemachines.Operation;
import org.imt.pssm.notreactive.statemachines.OperationBehavior;
import org.imt.pssm.notreactive.statemachines.Pseudostate;
import org.imt.pssm.notreactive.statemachines.PseudostateKind;
import org.imt.pssm.notreactive.statemachines.Region;
import org.imt.pssm.notreactive.statemachines.Signal;
import org.imt.pssm.notreactive.statemachines.SignalEventOccurrence;
import org.imt.pssm.notreactive.statemachines.SignalEventType;
import org.imt.pssm.notreactive.statemachines.State;
import org.imt.pssm.notreactive.statemachines.StateMachine;
import org.imt.pssm.notreactive.statemachines.StatemachinesFactory;
import org.imt.pssm.notreactive.statemachines.StatemachinesPackage;
import org.imt.pssm.notreactive.statemachines.StringAttribute;
import org.imt.pssm.notreactive.statemachines.StringAttributeValue;
import org.imt.pssm.notreactive.statemachines.StringComparisonOperator;
import org.imt.pssm.notreactive.statemachines.StringConstraint;
import org.imt.pssm.notreactive.statemachines.Transition;
import org.imt.pssm.notreactive.statemachines.TransitionKind;
import org.imt.pssm.notreactive.statemachines.Trigger;
import org.imt.pssm.notreactive.statemachines.Vertex;
...
public class StatemachinesPackageImpl extends EPackageImpl implements StatemachinesPackage {
	 ...
	 * @see org.imt.pssm.notreactive.statemachines.StatemachinesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
