...
import org.eclipse.gemoc.sample.ale.fsm.FsmFactory;
import org.eclipse.gemoc.sample.ale.fsm.FsmPackage;
import org.eclipse.gemoc.sample.ale.fsm.NamedElement;
...
public class FsmPackageImpl extends EPackageImpl implements FsmPackage {
	 ...
	 * @see org.eclipse.gemoc.sample.ale.fsm.FsmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EAttribute getStateMachine_ConsumedString() {
	...
	public void createPackageContents() {
		...
		createEAttribute(stateMachineEClass, STATE_MACHINE__CONSUMED_STRING);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getStateMachine_ConsumedString(), ecorePackage.getEString(), "consumedString", null, 0, 1, StateMachine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createDynamicAnnotations() {
		...
		addAnnotation
		  (getStateMachine_ConsumedString(),
		   source,
		   new String[] {
		   });
		addAnnotation
