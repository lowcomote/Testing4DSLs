...
/**
 * This is the item provider adapter for a {@link org.imt.bpmn.IntegerComparisonExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerComparisonExpressionItemProvider extends ExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 bpmnPackage.Literals.INTEGER_COMPARISON_EXPRESSION__OPERATOR,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 bpmnPackage.Literals.INTEGER_COMPARISON_EXPRESSION__OPERAND1,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 bpmnPackage.Literals.INTEGER_COMPARISON_EXPRESSION__OPERAND2,
				 true,
				 false,
				 true,
				 null,
