...
/**
 * This is the item provider adapter for a {@link org.imt.bpmn.BooleanBinaryExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 bpmnPackage.Literals.BOOLEAN_BINARY_EXPRESSION__OPERATOR,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 bpmnPackage.Literals.BOOLEAN_BINARY_EXPRESSION__OPERAND1,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 bpmnPackage.Literals.BOOLEAN_BINARY_EXPRESSION__OPERAND2,
				 true,
				 false,
				 true,
				 null,
