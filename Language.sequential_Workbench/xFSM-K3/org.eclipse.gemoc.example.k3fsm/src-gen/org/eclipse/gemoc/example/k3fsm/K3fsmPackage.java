...
public interface K3fsmPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.gemoc.example.k3fsm.FSM#getConsumedString <em>Consumed String</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Consumed String</em>'.
	 * @see org.eclipse.gemoc.example.k3fsm.FSM#getConsumedString()
	 * @see #getFSM()
	 * @generated
	 */
	EAttribute getFSM_ConsumedString();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute FSM__CONSUMED_STRING = eINSTANCE.getFSM_ConsumedString();
