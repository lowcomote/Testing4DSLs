 ...
 * </p>
 * <ul>
 *   <li>{@link org.imt.arduino.impl.BinaryExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.imt.arduino.impl.BinaryExpressionImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link org.imt.arduino.impl.BinaryExpressionImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BinaryExpressionImpl extends ExpressionImpl implements BinaryExpression {
	 ...
	 * @ordered
	 */
	protected static final BinaryOperatorKind OPERATOR_EDEFAULT = BinaryOperatorKind.SUB;
	...
	public void setOperator(BinaryOperatorKind newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, arduinoPackage.BINARY_EXPRESSION__OPERATOR, oldOperator, operator));
	}
