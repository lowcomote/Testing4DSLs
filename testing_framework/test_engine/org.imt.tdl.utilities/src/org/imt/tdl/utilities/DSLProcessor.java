...
public class DSLProcessor {
	...
	public void loadDSLMetaclasses(){
		if (dslEntries.get(ECORE) != null){
			String metamodelPath = getPathName(dslEntries.get(ECORE));
	...
	private void findAleClasses() {
		String aleFilePath = getPathName(dsl.getEntry(ALE).getValue());
		Resource aleResource = (new ResourceSetImpl()).getResource(URI.createPlatformPluginURI(aleFilePath, false), true);
	...
	public URI getEcoreResourceURI() {
		return URI.createPlatformResourceURI(getPathName(getPath2Ecore()), false);
	}
	
	public URI getEcorePluginURI() {
		return URI.createPlatformPluginURI(getPathName(getPath2Ecore()), false);
	}
	...
	public URI getBehavioralInterfaceResourceURI() {
		return URI.createPlatformResourceURI(getPathName(getPath2BehavioralInterface()), false);
	}
	
	public URI getBehavioralInterfacePluginURI() {
		return URI.createPlatformPluginURI(getPathName(getPath2BehavioralInterface()), false);
	}
	...
	public URI getCoverageRulesResourceURI() {
		return URI.createPlatformResourceURI(getPathName(getPath2CoverageRules()), false);
	}
	
	public URI getCoverageRulesPluginURI() {
		return URI.createPlatformPluginURI(getPathName(getPath2CoverageRules()), false);
	}
	...
	public URI getMutationOperatorsResourceURI() {
		return URI.createPlatformResourceURI(getPathName(getPath2MutationOperators()), false);
	}
	
	public URI getMutationOperatorsPluginURI() {
		return URI.createPlatformPluginURI(getPathName(getPath2MutationOperators()), false);
	}
	...
	public URI getAmplifierConfigResourceURI() {
		return URI.createPlatformResourceURI(getPathName(getPath2AmplifierConfig()), false);
	}
	
	public URI getAmplifierConfigPluginURI() {
		return URI.createPlatformPluginURI(getPathName(getPath2AmplifierConfig()), false);
	}
	
	private String getPathName(String path) {
		path = path.replace("platform:/plugin", "");
