...
public class TDLTestCaseCoverage {
	...
	public TestCoverageReport getTcObjectCoverageRepot() {
		TestCoverageReport report = getTcCoverageRepot(TDLCoverageUtil.DSLSPECIFICCOVERAGE);
		if (report == null) {
			report = getTcCoverageRepot(TDLCoverageUtil.TRACEBASEDCOVERAGE);
		}
		return report;
	}
