...
public class TestConfigurationGenerator {
	...
	private void generateGateInstances(ComponentType component) {
		...
		genericGate.setType(this.gateTypes.get(GENERIC_GATE_TYPE));
