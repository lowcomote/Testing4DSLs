...
public class TDLCoverageView extends ViewPart{
	...
	public static final String ID = "test.views.TDLCoverageViewPart"; //$NON-NLS-1$
	...
	public void createPartControl(Composite parent) {
		...
		Group TSCoverage = new Group(contents, SWT.FILL);
		FillLayout fill = new FillLayout(SWT.VERTICAL);
		TSCoverage.setLayout(fill);
		layout.numColumns = 1;
		layout.verticalSpacing = 9;
		TSCoverage.setText("Test Suite Coverage");
		gd = new GridData(GridData.FILL_HORIZONTAL | GridData.FILL_VERTICAL);
		gd.horizontalAlignment = SWT.FILL;
		TSCoverage.setLayoutData(gd);
		
	    final Tree addressTree = new Tree(TSCoverage, SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION);
		addressTree.setHeaderVisible(true);
		addressTree.setLinesVisible(true);
		final StyledText detailTextBox = new StyledText(TSCoverage, SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION| SWT.WRAP);
